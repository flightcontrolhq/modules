...
| `compute/`    | `aws_sandboxes`   | Ravion Sandboxes host pool: EC2 nested-virt fleet launch template, host IAM, ingress NLB/ACM/Route53, snapshot bucket. Ravion-managed (internal definition, seeded by the control plane) | v0.1.0  |
