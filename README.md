...
| `compute/`    | `ec2_service`     | Supervised EC2 workloads with standalone or ECS-cluster ALB routing, authenticated Git source checkout, switchable deploy modes, and deployment-scoped CloudWatch logs | v1.0.0  |
