...
| `compute/`    | `eks/addons`      | Selectable add-ons for an existing EKS cluster: Karpenter autoscaling, EBS CSI driver, and CloudWatch Container Insights (includes `rvn-eks-addons` module definition) | v1.0.0  |
