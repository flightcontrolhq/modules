...
| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| instance_profile_enabled | Whether to create an IAM instance profile for this role. | `bool` | `false` | no |
...
║           │                                               │                                               │            ║
║           ▼                                               ▼                                               ▼            ║
║  var.managed_policy_arns                    var.inline_policies                   var.instance_profile_enabled          ║
...
Set `instance_profile_enabled = true` to create an instance profile that EC2 instances can use:
