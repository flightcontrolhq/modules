...
output "instance_profile_arn" {
  ...
  value       = var.instance_profile_creation_enabled ? aws_iam_instance_profile.this[0].arn : null
}

output "instance_profile_name" {
  description = "The name of the IAM instance profile (null if not created)."
  value       = var.instance_profile_creation_enabled ? aws_iam_instance_profile.this[0].name : null
}

output "instance_profile_id" {
  description = "The ID of the IAM instance profile (null if not created)."
  value       = var.instance_profile_creation_enabled ? aws_iam_instance_profile.this[0].id : null
}
...
output "instance_profile_unique_id" {
  ...
  value       = var.instance_profile_creation_enabled ? aws_iam_instance_profile.this[0].unique_id : null
}
