...
- Optional multi-region primary key (`multi_region_enabled = true`).
...
| `multi_region_enabled`                | Create as a multi-region primary key.                                                                                                                                                                                                                                                                                                                        | `bool`         | `false`               | no       |
| `key_rotation_enabled`         | Enable annual automatic rotation. AWS only supports rotation for `SYMMETRIC_DEFAULT` + `ENCRYPT_DECRYPT`; ignored for any other shape.                                                                                                                                                                                                                       | `bool`         | `true`                | no       |
...
- **Symmetric (`SYMMETRIC_DEFAULT`)**: AWS rotates the key material annually when `key_rotation_enabled = true`. The alias and key ID stay constant.
