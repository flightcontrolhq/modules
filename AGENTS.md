...
- **Apply-action metadata**: Follow the `Apply Actions (applied_by)` section in `.agents/skills/module-definition-config/SKILL.md` when reviewing or testing input lifecycle metadata.
