...
output "parent_groups" {
  description = "Parent-mode output: map of group name → wildcard parent allocation + cert. Empty when mode = leaf. Service modules' cluster_inherit kind looks up entries here via cluster_group_name."
  value = {
