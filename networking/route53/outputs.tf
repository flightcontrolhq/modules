...
output "zone_arn" {
  ...
  value = (
    ...
    var.zone_enabled && var.private_zone ? aws_route53_zone.private[0].arn :
    null
  )
}
...
output "zone_name" {
  ...
  value = (
    ...
    var.zone_enabled && var.private_zone ? aws_route53_zone.private[0].name :
...
output "name_servers" {
  ...
  value = (
    ...
    var.zone_enabled && var.private_zone ? aws_route53_zone.private[0].name_servers :
...
output "primary_name_server" {
  ...
  value = (
    ...
    var.zone_enabled && var.private_zone ? aws_route53_zone.private[0].primary_name_server :
...
output "is_private_zone" {
  ...
  value       = var.zone_enabled ? var.private_zone : data.aws_route53_zone.existing[0].private_zone
}
...
output "dnssec_key_signing_key_id" {
  ...
  value       = var.dnssec_enabled ? aws_route53_key_signing_key.this[0].id : null
}
