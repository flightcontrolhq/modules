...
func TestVpcWithNatGateway(t *testing.T) {
	...
	// Assert NAT gateway is created (nat_gateway_high_availability_enabled=false means 1 NAT gateway)
...
func TestVpcWithHaNat(t *testing.T) {
	...
	// Assert 3 NAT gateways are created (one per AZ, since nat_gateway_high_availability_enabled=true)
