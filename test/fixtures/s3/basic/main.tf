################################################################################
# S3 Bucket Basic Fixture
#
# A minimal S3 bucket configuration for Terratest integration testing.
# Creates an S3 bucket with default security settings (public access blocked,
# SSE-S3 encryption).
################################################################################
