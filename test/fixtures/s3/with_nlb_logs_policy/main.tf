################################################################################
# S3 Bucket with NLB Access Logs Policy Fixture
#
# Creates an S3 bucket with NLB access logs policy template for Terratest
# integration testing. This fixture tests the policy_templates feature with
# both 'nlb_access_logs' and 'deny_insecure_transport' templates.
################################################################################
...
################################################################################
# S3 Bucket with NLB Access Logs Policy
################################################################################
...
module "s3_bucket" {
  ...
  # Apply NLB access logs and deny insecure transport policy templates
