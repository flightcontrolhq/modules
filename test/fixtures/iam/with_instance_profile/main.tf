################################################################################
# IAM Role with Instance Profile Fixture
#
# Creates an IAM role with an instance profile for EC2 instances.
# Includes a managed policy (AmazonSSMManagedInstanceCore) for SSM access.
################################################################################
...
module "iam_role" {
  ...
  name        = var.name
  description = "Terratest IAM role with instance profile for EC2"
  path        = "/test/"
