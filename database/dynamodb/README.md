...
module "dynamodb" {
  ...
  replicas = [
    ...
    { region_name = "eu-west-1", point_in_time_recovery_enabled = true },
  ]
}
```
...
| replicas                             | Global table v2 replica regions. Requires `stream_enabled = true`.                              | `list(object({ region_name = string, kms_key_arn = optional(string), tag_propagation_enabled = optional(bool), point_in_time_recovery_enabled = optional(bool) }))`                                                                                                                                                                                                                                                   | `[]`                                     | no       |
...
| cloudwatch_alarms_creation_enabled             | Create throttling & system-error alarms.                                                        | `bool`                                                                                                                                                                                                                                                                                                                                                                                                | `false`                                  | no       |
