...
locals {
  ...
  create_security_group    = var.security_group_enabled
  create_monitoring_role   = var.monitoring_role_enabled && var.monitoring_interval > 0
  create_cloudwatch_alarms = var.cloudwatch_alarms_enabled
  ...
  cluster_parameter_group_name = var.cluster_parameter_group_enabled ? aws_rds_cluster_parameter_group.this[0].name : var.cluster_parameter_group_name
  db_parameter_group_name      = var.db_parameter_group_enabled ? aws_db_parameter_group.this[0].name : var.db_parameter_group_name
